...
// Portal constants for this provider fork (hostkey-com).
const (
	DefaultBaseURL        = "https://invapi.hostkey.com/"
	PortalDomain          = "hostkey.com"
	SiblingPortalDomain   = "hostkey.ru"
	SiblingProviderSource = "hostkey-cloud-ru/hostkey-ru"
